...
python src/main.py deaminate -vcf data/archaic_admix_MHtarget/original/full/vcf/original_filtered_21.vcf -out ./test/deaminated_21.vcf -r 0.5

Example making all populations pseudohaploid:

python src/main.py pseudohaploid -vcf data/archaic_admix_MHtarget/original/full/vcf/original_filtered_21.vcf -out ./test/pseudohaploid_21.vcf 

Example making only populations 0 and 10 pseudohaploid:

python src/main.py pseudohaploid -vcf data/archaic_admix_MHtarget/original/full/vcf/original_filtered_21.vcf -out ./test/pseudohaploid_pop0pop10_21.vcf -target pop_0,pop_10
