...
def main():
    ...
    contam_subparser.add_argument("-modern", metavar='',help="Modern human individuals to contaminate with", type=str, default = "")
    ...
    if not args.mode:
        ...
        if args.mode == "contaminate":
            ...
            if args.ancestral:
                ...
                modern_list = parse_target_indivs(args.modern)
